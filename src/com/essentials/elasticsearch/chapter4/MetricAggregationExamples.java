/*
 * 文件名：MetricAggregationExamples.java
 * 修改人：TANCZ1
 * 修改时间：2017年2月14日
 */
...
public class MetricAggregationExamples {
	...
	public static void main(String[] args) throws IOException {
        ...
        MetricAggregationExamples metricagg=new MetricAggregationExamples();
        metricagg.extendedStatsAggregation(indexName, docType, fieldName);
	}
	...
	private void minAggregation(String indexName, String docType,String fieldName) {
		...
		System.out.print("min result:"+min);
	}
