...
//		operations.searchDocument(indexName, docType);
	 ...
	 * @param docType
	 */
	public void searchDocument(String indexName, String docType) {
		QueryBuilder query =QueryBuilders.termQuery("label_level", "4");
		...
		for (SearchHit hit : results) {
			...
			//process documents
			System.out.println(hit.getSource().get("label_name"));
		}
